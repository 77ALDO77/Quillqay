...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary text-on-primary shadow hover:saturate-150',
        destructive: 'bg-error text-on-error shadow-sm hover:bg-error/90',
        outline: 'border border-white/10 bg-transparent shadow-sm hover:bg-white/[0.04] text-on-surface-variant',
        secondary: 'bg-surface-container text-on-surface shadow-sm hover:bg-surface-container-high',
        ghost: 'hover:bg-white/[0.04] text-on-surface-variant',
